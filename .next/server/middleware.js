...
;// CONCATENATED MODULE: ./node_modules/next/dist/build/webpack/loaders/next-middleware-loader.js?absolutePagePath=private-next-root-dir%2Fmiddleware.ts&page=%2Fmiddleware&rootDir=C%3A%5CUsers%5Cedvin%5CDownloads%5Cproject-bolt-sb1-9wvhppmr%20(1)%5Cproject&matchers=&preferredRegion=&middlewareConfig=e30%3D!
...
var import_auth_helpers_shared = __webpack_require__(289);
var supabase;
function createClientComponentClient({ supabaseUrl = "https://keebszijifukhvpyfnlc.supabase.co", supabaseKey = "din_anon_key_här", options, cookieOptions, isSingleton = true } = {}) {
...
var import_auth_helpers_shared2 = __webpack_require__(289);
...
function createPagesServerClient(context, { supabaseUrl = "https://keebszijifukhvpyfnlc.supabase.co", supabaseKey = "din_anon_key_här", options, cookieOptions } = {}) {
    var _a;
    if (!supabaseUrl || !supabaseKey) {
        throw new Error("either NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY env variables or supabaseUrl and supabaseKey are required!");
    }
...
var import_auth_helpers_shared3 = __webpack_require__(289);
...
function createMiddlewareClient(context, { supabaseUrl = "https://keebszijifukhvpyfnlc.supabase.co", supabaseKey = "din_anon_key_här", options, cookieOptions } = {}) {
    var _a;
    if (!supabaseUrl || !supabaseKey) {
        throw new Error("either NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY env variables or supabaseUrl and supabaseKey are required!");
    }
...
var import_auth_helpers_shared4 = __webpack_require__(289);
...
function createServerComponentClient(context, { supabaseUrl = "https://keebszijifukhvpyfnlc.supabase.co", supabaseKey = "din_anon_key_här", options, cookieOptions } = {}) {
    var _a;
    if (!supabaseUrl || !supabaseKey) {
        throw new Error("either NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY env variables or supabaseUrl and supabaseKey are required!");
    }
...
var import_auth_helpers_shared5 = __webpack_require__(289);
...
function createRouteHandlerClient(context, { supabaseUrl = "https://keebszijifukhvpyfnlc.supabase.co", supabaseKey = "din_anon_key_här", options, cookieOptions } = {}) {
    var _a;
    if (!supabaseUrl || !supabaseKey) {
        throw new Error("either NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY env variables or supabaseUrl and supabaseKey are required!");
    }
...
// src/deprecated.ts
function createBrowserSupabaseClient({ supabaseUrl = "https://keebszijifukhvpyfnlc.supabase.co", supabaseKey = "din_anon_key_här", options, cookieOptions } = {}) {
...
function createServerSupabaseClient(context, { supabaseUrl = "https://keebszijifukhvpyfnlc.supabase.co", supabaseKey = "din_anon_key_här", options, cookieOptions } = {}) {
...
function createMiddlewareSupabaseClient(context, { supabaseUrl = "https://keebszijifukhvpyfnlc.supabase.co", supabaseKey = "din_anon_key_här", options, cookieOptions } = {}) {
