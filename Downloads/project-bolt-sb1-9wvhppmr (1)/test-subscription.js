 ...
 * Kör detta skript med: node test-subscription.js
 */
...
async function testSubscriptionFunctions() {
  ...
  try {
    ...
    if (usersError) {
      ...
      console.log('OBS: Du kanske behöver köra SQL-skriptet i supabase/migrations/20240101000001_add_stripe_rpc.sql för att skapa RPC-funktionen');
    } else {
